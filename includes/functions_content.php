		...
		if (!$denied)
		{
			...
			switch ($display_cat)
			{
				...
				case ATTACHMENT_CATEGORY_IMAGE:
					...
					$inline_link = $phpbb_root_path . $config['upload_path'] . '/' . $attachment['physical_filename'];
				...
				case ATTACHMENT_CATEGORY_THUMB:
					$l_downloaded_viewed = 'VIEWED_COUNT';
					$thumbnail_link = $phpbb_root_path . $config['upload_path'] . '/thumb_' . $attachment['physical_filename'];
